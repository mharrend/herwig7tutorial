...
class LesHouchesInterface : public LesHouchesReader {
 ...
 // begin own added functions
	virtual vector<string> optWeightsNamesFunc();

// end own added functions
...
// begin own additional functions 

vector<string> LesHouchesInterface::optWeightsNamesFunc()
{
std::vector<string> result;
result.push_back("No weight name defined");
return result;
} 

// end own additional functions
